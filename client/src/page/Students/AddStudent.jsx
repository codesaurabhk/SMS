        ...
        <div style={{ borderBottom: "1px solid #EAECF0" }}>
          <ul className="nav nav-tabs student-tabs mb-4 border-0">
            {[
              ...
              { id: "parents-guardian-details", label: "Parents/Guardian Details" },
          ...
          <div className="d-flex ">
            ...
            <div className="p-3">
              ...
              <div >
                ...
                <div className="p-2 ms-2  rounded-3 mt-2 " style={{ width: "290px", border: "1px dashed #2632381A" }} >
                ...
                <div className="p-2 ms-2 mt-3  rounded-3 mt-2 " style={{ width: "290px", border: "1px dashed #2632381A" }} >
                  {/* <div>Files</div> */}
                  <div className="d-flex justify-content-between">
              ...
              <div className="d-flex gap-3 ms-2 " style={{ marginTop: "10rem" }}>
                <div className="mt-4 text-end ">
                  <button type="submit" className="btn btn-outline-secondary " style={{ width: "95px" }}>
                    Cancel
                  </button>
                </div>
                <div className="mt-4 text-end">
                  <button type="submit" className="btn btn-outline-primary" style={{ width: "95px" }}>
                    Save
                  </button>
                </div>
                <div className="mt-4 text-end">
                  <button type="submit" className="btn btn-primary" style={{ width: "95px" }}>
                    Next
                  </button>
                </div>
              </div>
